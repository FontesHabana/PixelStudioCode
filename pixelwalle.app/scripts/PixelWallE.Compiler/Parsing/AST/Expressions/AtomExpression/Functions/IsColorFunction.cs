...
/// <summary>
/// Represents a function that checks if a given value is a valid color in the PixelWallE language AST.
/// </summary>
public class IsColorFunction : Function
{
    /// <summary>
    /// Gets or sets the list of arguments (the value to check).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the value of the function (true if the value is a valid color, false otherwise).
    /// </summary>
    public override object? Value { get; set; }

    /// <summary>
    /// Initializes a new instance of the <see cref="IsColorFunction"/> class.
    /// </summary>
    ...
    /// <param name="args">The list of argument expressions (the value to check).</param>
