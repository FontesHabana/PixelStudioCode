...
/// <summary>
/// Represents a "greater than" comparison operation (e.g., 10 > 5) in the PixelWallE language AST.
/// </summary>
public class GreatherThanOperation : BinaryExpression
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GreatherThanOperation"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Accepts a visitor for traversing or processing the "greater than" operation node.
    /// </summary>
