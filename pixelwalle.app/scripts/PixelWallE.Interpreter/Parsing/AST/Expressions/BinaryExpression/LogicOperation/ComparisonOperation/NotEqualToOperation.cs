...
/// <summary>
/// Represents a "not equal to" comparison operation (e.g., 5 != 10) in the PixelWallE language AST.
/// </summary>
public class NotEqualToOperation : BinaryExpression
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NotEqualToOperation"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Accepts a visitor for traversing or processing the "not equal to" operation node.
    /// </summary>
